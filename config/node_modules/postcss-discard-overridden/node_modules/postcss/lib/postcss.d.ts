declare module "postcss" {
    ...
    namespace postcss {
        ...
        interface SourceMapOptions {
             ...
             * PostCSS will always add a common with a path to the source map. PostCSS will
             * not add annotations to CSS files that do not contain any comments.
             *
             * By default, PostCSS presumes that you want to save the source map as
             * opts.to + '.map' and will use this path in the annotation common. A different
        ...
        interface Container extends Node {
            ...
            /**
             * Traverses the container's descendant nodes, calling `callback` for each
             * common. Like container.each(), this method is safe to use if you are
             * mutating arrays during iteration.
             * @param callback Iterator called for each common node within the container.
             */
